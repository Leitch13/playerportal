...
/**
 * Latest allowed start date — 28 days from today.
 *
 * Stage 3's activation cron handles future-start signups by deferring the
 * Stripe subscription creation until the chosen date. Capped at +28 days to
 * limit how much pending state accumulates in the DB and to keep the
 * SetupIntent valid (Stripe SetupIntents expire after 30 days inactive).
 */
