...
export default function FeaturesByAudience() {
  ...
  const academyFeatures: Feature[] = [
    ...
    { icon: '', title: 'Smart Scheduling', desc: 'Per-class capacity caps, waitlists, sessions-per-week enforcement. Parents can\'t over-book; you can\'t over-promise.' },
    ...
    { icon: '', title: 'Branded Booking Page', desc: 'Your logo, your colours, your terms. Public booking page parents can sign up + pay through. No setup fee.' },
    { icon: '', title: 'Policies & T&Cs', desc: 'Set cancellation notice period, refund policy, late-payment grace. Parents tick + accept legally tracked on signup.' },
  ...
  const parentFeatures: Feature[] = [
    ...
    { icon: '', title: 'Cancel Anytime', desc: 'Honest cancellation flow. See exactly when your subscription ends. No phone calls, no chasing.' },
  ]
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col items-center gap-5 mb-14">
        ...
        >
          ...
          >
            <span className="mr-2"></span> For Academies
          </button>
          <button
