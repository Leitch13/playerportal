    ...
    <Card title="Give an Award">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          ...
          className="w-full sm:w-auto bg-[#0f1a2b] text-black font-semibold rounded-lg px-6 py-2.5 text-sm hover:bg-white/90 disabled:opacity-40 disabled:cursor-not-allowed transition"
        >
