...
export default async function InvoicePage({
  ...
  return (
    <div className="invoice-page max-w-3xl mx-auto">
      ...
      {/* Invoice document */}
      <div className="bg-[#0f1a2b] rounded-xl shadow-sm border border-gray-200 print:shadow-none print:border-0 print:rounded-none">
        {/* Header */}
        ...
        {/* Footer */}
        <div className="px-8 py-6 border-t border-gray-200 bg-[#080e18] rounded-b-xl print:bg-transparent">
