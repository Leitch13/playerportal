...
export default function PaymentLinkGenerator() {
  ...
  if (!open) {
    return (
      <button
        ...
        className="px-3 py-1.5 border border-[#1d2c42] rounded-lg text-xs font-medium hover:bg-white/5 transition-colors"
      >
  ...
  return (
    <div className="bg-[#0f1a2b] rounded-xl border border-[#1d2c42] p-5 space-y-4">
      ...
      {!link ? (
        ...
        <div className="space-y-3">
          <div className="bg-[#080e18] rounded-lg p-3">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                readOnly
                value={link}
                className="flex-1 px-3 py-2 border border-[#1d2c42] rounded-lg text-sm bg-[#0f1a2b] font-mono text-xs"
              />
              <button
                onClick={copyLink}
