export default function SettingsLoading() {
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="h-8 w-32 bg-[#0f1a2b] rounded-lg animate-pulse" />

      {/* Tabs */}
      <div className="flex gap-2 animate-pulse">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="h-9 w-24 bg-[#0f1a2b] rounded-lg" />
        ))}
      </div>

      {/* Settings form sections */}
      <div className="bg-[#0f1a2b] border border-[#1d2c42] rounded-xl p-6 space-y-6 animate-pulse" style={{ animationDelay: '100ms' }}>
      ...
      <div className="bg-[#0f1a2b] border border-[#1d2c42] rounded-xl p-6 space-y-4 animate-pulse" style={{ animationDelay: '200ms' }}>
        ...
        {[...Array(3)].map((_, i) => (
          <div key={i} className="flex items-center justify-between py-3 border-b border-[#1d2c42] last:border-0">
