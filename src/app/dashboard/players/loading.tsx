    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="h-9 w-48 bg-[#0f1a2b] rounded-lg animate-pulse" />
      ...
      {/* Search / filter bar */}
      <div className="flex items-center gap-3">
        <div className="h-10 flex-1 max-w-sm bg-[#0f1a2b] border border-[#1d2c42] rounded-lg animate-pulse" />
        <div className="h-10 w-28 bg-[#0f1a2b] border border-[#1d2c42] rounded-lg animate-pulse" />
      </div>
