  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <div className="h-10 w-44 bg-[#0f1a2b] border border-[#1d2c42] rounded-lg animate-pulse" />
        <div className="h-10 w-36 bg-[#0f1a2b] border border-[#1d2c42] rounded-lg animate-pulse" />
      </div>

      {/* Attendance list */}
      <div className="bg-[#0f1a2b] border border-[#1d2c42] rounded-xl overflow-hidden">
        {/* List header */}
        <div className="flex items-center gap-4 px-5 py-3 border-b border-[#1d2c42] animate-pulse">
        ...
        {[...Array(8)].map((_, i) => (
          <div
            key={i}
            className="flex items-center gap-4 px-5 py-3.5 border-b border-[#1d2c42] last:border-0 animate-pulse"
