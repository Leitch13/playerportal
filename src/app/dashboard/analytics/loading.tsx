  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-[#0f1a2b] border border-[#1d2c42] rounded-xl p-6 animate-pulse" style={{ animationDelay: '200ms' }}>
          <div className="h-5 w-40 bg-white/[0.06] rounded mb-4" />
          <div className="h-48 bg-white/[0.04] rounded-lg" />
        </div>
        <div className="bg-[#0f1a2b] border border-[#1d2c42] rounded-xl p-6 animate-pulse" style={{ animationDelay: '300ms' }}>
      ...
      {/* Heatmap area */}
      <div className="bg-[#0f1a2b] border border-[#1d2c42] rounded-xl p-6 animate-pulse" style={{ animationDelay: '400ms' }}>
