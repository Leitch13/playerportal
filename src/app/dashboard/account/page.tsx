  ...
  return (
    ...
    <div className="space-y-6">
      ...
      <Card title="Your Details">
        <div className="mb-4 flex flex-wrap gap-2 text-sm text-white/60">
          <span className="inline-block px-2 py-0.5 rounded-full bg-[#4ecde6]/10 text-[#4ecde6] font-medium text-xs">
            {user.email}
          </span>
          <span className="inline-block px-2 py-0.5 rounded-full bg-[#4ecde6]/10 text-[#4ecde6] font-medium text-xs capitalize">
            {profile?.role || 'parent'}
          </span>
          {org && (
            <span className="inline-block px-2 py-0.5 rounded-full bg-yellow-500/15 text-yellow-400 font-medium text-xs">
              {org.name}
            </span>
          )}
        </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Link
                      ...
                      className="font-medium text-sm hover:text-[#4ecde6] transition-colors"
                    >
