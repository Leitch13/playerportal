...
export default function SessionPlanView({ plan, orgName, orgLogo, suggestedDrills = [] }: { plan: Plan; orgName: string; orgLogo: string; suggestedDrills?: Drill[] }) {
  ...
  return (
    <>
      ...
      <div className="bg-[#0f1a2b] border border-[#1d2c42] rounded-2xl overflow-hidden print:bg-white print:text-black print:border-gray-200 max-w-3xl">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#4ecde6]/20 to-transparent p-6 border-b border-[#1d2c42] print:bg-gray-50 print:border-gray-200">
        ...
        <div className="p-6 space-y-6">
          ...
          {plan.diagram_url && (
            <div>
              ...
              <img src={plan.diagram_url} alt="Pitch diagram" className="max-w-full rounded-xl border border-[#1d2c42] print:border-gray-200" />
            </div>
          )}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {suggestedDrills.map((drill) => (
                  <div key={drill.id} className="bg-white/[0.03] border border-[#1d2c42] rounded-lg p-3 print:bg-gray-50 print:border-gray-200">
        ...
        {/* Footer */}
        <div className="px-6 py-3 border-t border-[#1d2c42] text-xs text-white/30 print:border-gray-200 print:text-gray-400">
