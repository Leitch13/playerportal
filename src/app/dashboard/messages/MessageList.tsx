      ...
      <div className="p-3 flex-shrink-0">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-[#142236] border border-[#293b58] rounded-xl text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-[#4ecde6]/40 focus:ring-1 focus:ring-[#4ecde6]/20 transition-colors"
          />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {filtered.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 px-4">
            <div className="w-12 h-12 bg-[#0f1a2b] rounded-xl flex items-center justify-center mb-3 border border-[#1d2c42]">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
          ...
          filtered.map((thread) => {
            ...
            return (
              <button
                ...
                className={`w-full text-left px-3 py-3 flex items-center gap-3 transition-all border-b border-[#1d2c42] hover:bg-[#142236] ${
                  isSelected ? 'bg-[#142236] border-l-2 border-l-[#4ecde6]' : ''
                }`}
              >
                {/* Avatar */}
