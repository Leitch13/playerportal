...
export default function DrillCard({
  ...
  return (
    <div className="bg-[#0f1a2b] border border-[#1d2c42] rounded-xl p-5 hover:border-[#293b58] hover:bg-[#142236] transition-colors flex flex-col">
      ...
      {/* Meta row */}
      <div className="flex items-center gap-4 text-xs text-white/40 mt-auto pt-3 border-t border-[#1d2c42]">
      ...
      {/* Owner actions */}
      {isOwner && (
        <div className="flex items-center gap-3 mt-3 pt-3 border-t border-[#1d2c42]">
          <button
