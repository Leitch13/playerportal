...
export default function BookClassButton({
  ...
  async function handleBook() {
    ...
    if (isFull) {
      ...
      // Schema fix: real column is group_id (not training_group_id). This is
      // a client component so WAITLIST_SCHEMA_FIX_ENABLED isn't reachable
      // without NEXT_PUBLIC_ prefix; the previous code was broken (insert
      // failed with column-not-found) so unconditional fix is safe — today's
      // path doesn't work either. Rollback = git revert + redeploy.
